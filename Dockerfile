...
RUN \
curl -L https://launchpad.net/lightdm-webkit-greeter/trunk/2.0.0/+download/lightdm-webkit-greeter-2.0.0.tar.gz > lightdm-webkit-greeter-2.0.0.tar.gz && \
tar -xzf lightdm-webkit-greeter-2.0.0.tar.gz && \
mv lightdm-webkit-greeter-2.0.0 greeter && \
mkdir -p /root/lightdm-webkit-greeter_2.0.0/DEBIAN 
